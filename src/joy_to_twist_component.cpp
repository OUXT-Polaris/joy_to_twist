...
namespace joy_to_twist
{
    ...
    {
        this->set_on_parameters_set_callback(std::bind(&JoyToTwistComponent::paramCallback, this, std::placeholders::_1));
    ...
    rcl_interfaces::msg::SetParametersResult JoyToTwistComponent::paramCallback(const std::vector<rclcpp::Parameter> & params)
    {
